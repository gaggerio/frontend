            ...
            <div>
                <section class="header">
                    <input
                        type="text"
                        class="c-input"
                        v-model="currLine.txt"
                        @input="memeStore.saveMoves"
                    />
                </section>
                <section class="actions">
                    <button class="c-btn" @click="memeStore.switchLine">
                        <img
                            src="https://res.cloudinary.com/dokgseqgj/image/upload/v1685437460/switch_d5ub71.ico"
                            alt=""
                        />
                    </button>
                    <button class="c-btn" @click="memeStore.addLine">
                        <img
                            src="https://res.cloudinary.com/dokgseqgj/image/upload/v1685437941/add_sitydf.ico"
                            alt=""
                        />
                    </button>
                    <button class="c-btn" @click="memeStore.removeLine">
                        <img
                            src="https://res.cloudinary.com/dokgseqgj/image/upload/v1685438035/delete_i6rw0s.ico"
                            alt=""
                        />
                    </button>
                    <button class="c-btn" @click="memeStore.undo">
                        <img
                            src="https://res.cloudinary.com/dokgseqgj/image/upload/v1685445166/undo_lhrr1z.ico"
                            alt=""
                        />
                    </button>
                </section>
                <section class="edits">
                    <button class="c-btn">
                        <input
                            type="color"
                            v-model="currLine.strokeStyle"
                            class="color-picker"
                            @change="memeStore.saveMoves"
                        />
                        <img
                            src="https://res.cloudinary.com/dokgseqgj/image/upload/v1685438264/brush_nmfgnk.ico"
                            alt=""
                        />
                    </button>
                    <button class="c-btn">
                        <input
                            type="color"
                            v-model="currLine.fillStyle"
                            class="color-picker"
                            @change="memeStore.saveMoves"
                        />
                        <img
                            src="https://res.cloudinary.com/dokgseqgj/image/upload/v1685438570/fill_aqjfnt.ico"
                            alt=""
                        />
                    </button>
                    <button class="c-btn" @click="memeStore.setFontSize(5)">
                        <img
                            src="https://res.cloudinary.com/dokgseqgj/image/upload/v1685439066/increase-text-size_tnyqsu.ico"
                            alt=""
                        />
                    </button>
                    <button class="c-btn" @click="memeStore.setFontSize(-5)">
                        <img
                            src="https://res.cloudinary.com/dokgseqgj/image/upload/v1685439047/decrease-text-size_tke5a2.ico"
                            alt=""
                        />
                    </button>
                </section>
